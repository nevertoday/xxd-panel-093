...
```text
/xxd-panel-093 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，093 设计在下）
2. 左右对照（原图在左，093 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-093/<fresh-task>/
...
- `references/xxd-panel-093-prompt.zh-CN.md`
- `references/xxd-panel-093-prompt.en.md`
