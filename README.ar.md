<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 093" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 093｜لوحة هندسية حديثة

### يحوّل الصور إلى هندسة حداثية زاهية ومساحات لونية مطفأة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 093 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

قد تحجب المناظير والخامات والتفاصيل المتناثرة في الصورة الأشكال والعلاقات القليلة التي تجعلها جديرة بالتذكر. يزيل Panel 093 هذا التشويش البصري من دون فقدان الهوية.

يضغط **Panel 093** الموضوع والوضع والبنية والعلاقة السردية مباشرة إلى عدد قليل من الأشكال الهندسية والحرة. ويستبدل المنظور الواقعي والمتجهات المصقولة بالتراكب وتغيّر المقياس والألوان الزاهية المستمدة من الصورة والحواف اليدوية غير المنتظمة قليلًا وملمس الغواش المطفأ لبناء فضاء تصويري مسطّح.

### مناسب لـ

- جعل الصور المعقدة مقروءة فورًا عبر عدد قليل من الأشكال الكبيرة؛
- إعادة تنظيم أقوى ذكريات اللون في الصورة ضمن منظومة زاهية وراقية؛
- فضاء تصويري مسطّح وحواف يدوية وطابع تحريري مطفأ مستلهم من منتصف القرن؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 093 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** لون هندسي مسطّح · فضاء تصويري مسطّح · لون زاهٍ مستمد من الصورة · حواف يدوية · غواش مطفأ · إيضاح تحريري مستلهم من منتصف القرن
...
|---|---|
| **الناتج** | إيضاح حداثي هندسي مسطّح الألوان، زاهٍ ومضبوط وذو ملمس يدوي |
| **البصمة الواضحة** | أشكال هندسية كبيرة قليلة، فضاء مسطّح، كتل لونية زاهية، حواف يدوية وملمس طلاء مطفأ |
| **احترام المصدر** | يحفظ الهوية والوضع والسرد وذاكرة اللون، ولا يفرض قالبًا حضريًا على كل مصدر |
...
```text
تحليل الموضوع والمحيط والبنية والوضع والعلاقة السردية → دمج التفاصيل المعقدة والعناصر المتكررة → ضغط الموضوع مباشرة إلى أشكال هندسية وحرة قليلة → بناء الفضاء المسطّح بالتراكب والمقياس ومساحات اللون → إعادة تنظيم أكثر ذكريات الصورة اللونية إشراقًا وحيوية → إضافة حواف يدوية وملمس غواش/أكريليك مطفأ → دمج قدر ضئيل جدًا من الطباعة التحريرية في التكوين الهندسي
```

## سمات النتيجة النهائية

- حوّل الموضوع نفسه إلى هندسة بدل تتبع محيطه الواقعي بخطوط هندسية، مع إبقاء هويته مقروءة عبر أشكال كبيرة قليلة.
- ابنِ الفضاء بالتراكب والمقياس وتراصف كتل اللون والعلاقات الرأسية بدل الحجم الواقعي.
- استمد المنظومة من أكثر ألوان الصورة إشراقًا وقابلية للتذكر، مع الحفاظ على الحيوية من دون فلورسنت أو ألوان حلوى رخيصة.
- ادمج طباعة إنسانية مقتصدة مع محاور الأشكال وحوافها والفراغ.
- تجنّب الواقعية والمنظور المعقد والظلال الثقيلة والمتجهات المصقولة وثلاثي الأبعاد والملصقات الكرتونية وقوالب ملصقات السفر.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-093-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 093. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-093 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-093 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-093 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-093 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-093 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 093 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-093 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-093`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-093-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-093-prompt.zh-CN.md)
...
| **[xxd-panel-093](https://github.com/nevertoday/xxd-panel-093)** | لون هندسي مسطّح · فضاء تصويري مسطّح · ألوان زاهية من الصورة · حواف يدوية · غواش مطفأ · تحرير مستلهم من منتصف القرن |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–093) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
