<p align="center"><img src="./assets/banner.svg" alt="XXD Panel 093 project banner" width="1200"></p>
...
Sample positions are reserved. Verifiable original works or extensions reviewed directly against the Panel 093 source brief will be shown here first; images from another numbered Panel and broken placeholders are never substituted.
...
```text
analyse subject, contour, pose, and narrative relation → merge repeated detail → compress the subject into a few geometric and free-form shapes → build flattened space through overlap, scale, and colour layering → reorganise the source's brightest colour memories → add handmade edges and matte gouache/acrylic texture → integrate sparse editorial type into the geometry
```

## Recognisable finished traits

- Geometrise the subject itself rather than tracing it with geometric lines.
- Build space through overlap, scale, layered colour fields, and vertical relationships rather than realistic volume.
- Draw colour from the brightest, most memorable parts of the photograph and keep it vivid without becoming neon or candy-like.
- Integrate sparse humanistic typography with shape axes, edges, and whitespace.
- Avoid realism, complex perspective, heavy shadows, polished vectors, 3D, cartoon stickers, and templated travel posters.

All aesthetic constraints live only in the [canonical prompt](references/original-prompt/zh-CN.md). The Skill and runtime adapters resolve delivery variables. [Skill workflow](SKILL.md) · [English runtime adapter](references/xxd-panel-093-prompt.en.md)
...
| **[xxd-panel-093](https://github.com/nevertoday/xxd-panel-093)** | GEOMETRIC FLAT COLOUR · FLATTENED PICTORIAL SPACE · VIVID SOURCE COLOUR · HANDMADE EDGES · MATTE GOUACHE · MID-CENTURY EDITORIAL |
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–093) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
